...
from belgian_gp_predictor import BelgianGPPredictor
import os
import logging
...
app = FastAPI(title="F1-AI-Predictor API")
...
async def predict_belgian_gp():
    """Get 2025 Belgian GP predictions"""
    try:
        logger.info("Generating predictions for 2025 Belgian GP...")
        predictions_df = predictor.predict_belgian_gp()
